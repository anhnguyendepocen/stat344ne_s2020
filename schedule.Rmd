 ...
 * **In class**, we will work on:
    ...
    * If extra time, revisit lab 4.  Working just with Keras, see if you can get improved performance for the IMDB ratings example by changing the size of each layer and adding regularization.
 * **After class**, please:
...
#### Fri, Feb 21
 * **In class**, we will work on:
    * Start on convolutional neural networks
 * **After class**, please:
