...
#### Wed, Feb 12
 * **In class**, we will work on:
    * Continue on backpropagation with hidden layers
    * Lab on backpropagation
 * **After class**, please:


#### Fri, Feb 14
 * **In class**, we will work on:
    * A few miscellaneous points about gradient descent:
        * Issues with gradient descent, step sizes, and stochastic gradient descent: [pdf](materials/20200214_SGD/20200214_SGD.pdf)
 * **After class**, please:
")
```
