...
#### Wed, Feb 05
 * **In class**, we will work on:
    * Gradient Descent, start on backpropagation for logistic regression.  Lecture notes: [pdf](materials/20200205_grade_descent_logistic/lecture_notes.pdf).  Note there is an error on page 6 that we did not make in class: $dJdz = a - y$, not $y - a$.
 * **After class**, please:
    * **Videos**
...
#### Fri, Feb 07
 * **In class**, we will work on:
    * Loss functions, activation functions, and their derivatives.  [pdf](materials/20200207_loss_activation_derivs/202007_loss_activation_derivs.pdf)
