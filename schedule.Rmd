 ...
 * **After class**, please:
    ...
    * **Homework 0** due 5 pm Fri, Jan 31
...
#### Mon, Jan 27
 * **In class**, we will work on:
    * Maximum likelihood and output activations for regression and multi-class classification.
    * Lab 1 about numpy calculations relevant to logistic regression
 * **After class**, please:
    * **Videos**
