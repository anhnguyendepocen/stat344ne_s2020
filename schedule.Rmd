...
#### Wed, Jan 29
 * **In class**, we will work on:
    * Maximum likelihood and output activations for multi-class classification.
    * Intro to Keras
 * **After class**, please:
    * **Videos**
 ...
 * **In class**, we will work on:
    ...
    * Maybe start on hidden layers and forward propagation?
 * **After class**, please:
    * **Homework 1**
...
#### Mon, Feb 03
 * **In class**, we will work on:
    * Hidden layers and forward propagation if not done last Friday
    * Otherwise, start on gradient descent
 * **After class**, please:
